...
<body>
    <header>
        ...
        <!--<div class="nav-bg">-->
            <div class="logo">
                <a href="index.php"><img src="src/img/Logotipo_login_Siglo_XXI_2.png" alt=""></a>
                
                
            </div>
            <nav class="navegacion-principal contenedor"> <!--Menu de navegación-->
                <a id="linkReservacion" href="../../reservacion.php">Reservación</a>
                <a id="linkMenu" target="_blank" href="../../menu.html">Menú</a>
